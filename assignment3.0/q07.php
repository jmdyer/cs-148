...
$query = 'SELECT tblStudents.fldFirstName, tblStudents.fldLastName, COUNT(tblEnrolls.fnkStudentID) AS "Number of Classes", AVG(fldGrade) AS "GPA" FROM tblEnrolls
INNER JOIN tblStudents ON tblStudents.pmkStudentId = tblEnrolls.fnkStudentId
WHERE tblStudents.fldState = "VT" 
